...
<ul>
	<div class="topnav" id="myTopnav">
 		<a href="/">Home</a>
  		<a class="active" href="/client/caseSummary">Cases</a>
...
<div id="myDIV" class="container" style="width:450px;">
      <form class="form-signin" action="/client/newCase" >
      	<hr size="10">
        ...
        <input name="creditorName" type="hidden" id="inputPassword" class="form-control" value="${User.companyName}">
	...
	<label for="verificationNumber" class="sr-only">Title</label>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="button" onclick="window.location.href='/client/caseSummary'">Cancel</button>
        
      </form>
</div> <!-- /container -->

<div id="myDIV2" class="container" style="width:450px;">
      <form class="form-signin" action="/client/newCase2" >
      	<hr size="10">
  		<h2 style="font-size: 20px;">Case Details</h2>
        <hr size="10">
...
Ajax validation to check if debtor already exists
</p>
</body>
</html>