...
<ul>
	<div class="topnav" id="myTopnav">
 		<a href="/">Home</a>
  		...
  		<a class="active" href="/client/caseOfficers">Case Officers</a>
...
<div class="container" style="width:450px;">
      <form class="form-signin" action="/client/clientRegister">
      	<h2 class="form-signin-heading" style="font-size:30px;">Case Officer Registration</h2>
      	<hr size="10">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="button" onclick="window.location.href='/client/clientDashboard'">Cancel</button>
